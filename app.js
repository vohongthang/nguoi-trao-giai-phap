...
(function () {
  ...
  var GROUPS = [
    { key: "vp-tk", label: "Văn Phòng - Thống Kê" },
    { key: "dc-xd-mt", label: "Địa Chính - Xây Dựng - Môi Trường" },
    { key: "tp-ht", label: "Tư Pháp - Hộ Tịch" },
    { key: "vh-xh", label: "Văn Hóa - Xã Hội" },
    { key: "tc-kt", label: "Tài Chính - Kế Toán" },
    { key: "qs-an", label: "Quân Sự & An Ninh Xã" }
  ];
  ...
  function renderGroups() {
    ...
    GROUPS.forEach(function (g, gi) {
      ...
      html += '<div class="role-group-head"><span class="gnum">' + (gi + 1) + "</span><h3>" + escHtml(g.label) + "</h3></div>";
